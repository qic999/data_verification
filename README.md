...
- a separate 3D-evidence result column that shows pilot/full scope and keeps
...
and `3D_EVIDENCE_AUDIT_V3_REPORT.md` for the current calibration-pilot results.
